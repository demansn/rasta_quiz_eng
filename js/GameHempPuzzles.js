...
GameHempPuzzles.close = function() {
	this.showMessageConfirm("Закрыть игру?", function(keyId) {
		if (keyId == 1) {
		...
		if (!this.isInit) {
			...
			var calback = function() {
				...
				if (GameHempPuzzles.storege.getData("data")) {
					...
					GameHempPuzzles.showMessageConfirm("Продолжить с последнего вопроса?", function(keyId) {
